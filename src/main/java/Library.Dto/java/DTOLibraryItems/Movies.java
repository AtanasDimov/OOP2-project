...
public class Movies extends VisualMediaItem{
    ...
    public Movies(){}
    public Movies(String title, String description, LocalDate publishDate, int quantity, int runtime, String videoQuality, MoviesAgeRating rating) {
        super(title, description, publishDate, quantity, runtime, videoQuality);
        this.rating = rating;
    }
